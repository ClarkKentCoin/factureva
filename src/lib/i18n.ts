...
const resources = {
  fr: {
    translation: {
      ...
      activities: {
        title: "Activités",
        description: "Vos activités déclarées et catégorisations métier.",
        ...
        category: {
          ...
          physical_production: "Production physique",
  ...
  en: {
    translation: {
      ...
      activities: {
        title: "Activities",
        description: "Your declared activities and business categorisation.",
        new: "New activity",
        edit: "Edit activity",
        emptyTitle: "No activities yet",
        emptyDescription: "Create activities to structure your catalog and invoices.",
        fields: {
          name: "Name", category: "Category", code: "Code / slug",
          description: "Description", is_active: "Active",
        },
        category: {
          web_design: "Web design", web_development: "Web development",
          consulting: "Consulting", digital_services: "Digital services",
          goods_sales: "Goods sales", ecommerce: "E-commerce",
          physical_production: "Physical production", mixed: "Mixed business",
          other: "Other",
        },
      },
      items: {
  ...
  ru: {
    translation: {
      ...
      activities: {
        ...
        description: "Заявленные виды деятельности и бизнес-категории.",
        ...
        fields: {
          name: "Название", category: "Категория", code: "Код / slug",
          description: "Описание", is_active: "Активна",
        },
        category: {
          web_design: "Веб-дизайн", web_development: "Веб-разработка",
          consulting: "Консалтинг", digital_services: "Цифровые услуги",
          goods_sales: "Продажа товаров", ecommerce: "E-commerce",
          physical_production: "Физическое производство", mixed: "Смешанная деятельность",
          other: "Другое",
        },
      },
      items: {
